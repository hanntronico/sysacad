 ...
 function vergrafico()
{
	...
	posicion_x=(screen.width/2)-(403/2); 
	posicion_y=(screen.height/2)-(300/2); 

	window.open("muestra_graf.php?cur="+cur,"ventana1","width=403,height=300,scrollbars=NO,left="+posicion_x+",top="+posicion_y); 
...
<table cellpadding="5" cellspacing="3" class="tbmat">
		...
		<tr>
			...
			<?php $db = null; ?>			
				...
				&nbsp; <input type="button" name="btnbuscar" value="..:GRAFICAR:.." onclick="vergrafico();">
				<!-- icono_pdf.gif -->
